...
insert into T_SYS_FUNCTION (function_code, menu_code, function_name, function_flag, function_dependency, service_id)
values ('05020101', '050201', '发布记录管理', '1', null, null);
insert into T_SYS_FUNCTION (function_code, menu_code, function_name, function_flag, function_dependency, service_id)
values ('05030101', '050301', '内容库管理', '1', null, null);
insert into T_SYS_FUNCTION (function_code, menu_code, function_name, function_flag, function_dependency, service_id)
...
insert into T_SYS_FUNCTION (function_code, menu_code, function_name, function_flag, function_dependency, service_id)
values ('05040101', '050401', '规格配置', '1', null, null);
commit;
...
insert into T_SYS_MENU (menu_code, sys_config_id, menu_name, target_url, parent_code, sort_index, menu_enable_flag, remark, menu_image_url)
values ('0504', '0504', '诱导屏管理', null, '05', '4', '1', null, null);
insert into T_SYS_MENU (menu_code, sys_config_id, menu_name, target_url, parent_code, sort_index, menu_enable_flag, remark, menu_image_url)
...
insert into T_SYS_MENU (menu_code, sys_config_id, menu_name, target_url, parent_code, sort_index, menu_enable_flag, remark, menu_image_url)
values ('050401', '050401', '规格配置', 'tpls/informationDelivery/inducedScreenRelease/specifications-config-list.html', '0504', '1', '1', null, null);
insert into T_SYS_MENU (menu_code, sys_config_id, menu_name, target_url, parent_code, sort_index, menu_enable_flag, remark, menu_image_url)
...
insert into T_SYS_MENU (menu_code, sys_config_id, menu_name, target_url, parent_code, sort_index, menu_enable_flag, remark, menu_image_url)
values ('0502', '0502', '发布记录管理', null, '05', '2', '1', null, null);
insert into T_SYS_MENU (menu_code, sys_config_id, menu_name, target_url, parent_code, sort_index, menu_enable_flag, remark, menu_image_url)
values ('0503', '0503', '内容库管理', null, '05', '3', '1', null, null);
insert into T_SYS_MENU (menu_code, sys_config_id, menu_name, target_url, parent_code, sort_index, menu_enable_flag, remark, menu_image_url)
values ('050301', '050301', '内容库管理', 'tpls/informationDelivery/contentLibraryManage/content-library-manage-list.html', '0503', '1', '1', null, null);
insert into T_SYS_MENU (menu_code, sys_config_id, menu_name, target_url, parent_code, sort_index, menu_enable_flag, remark, menu_image_url)
values ('050201', '050201', '发布记录管理', 'tpls/informationDelivery/releaseInfoManage/release-info-manage-list.html', '0502', '1', '1', null, null);
commit;
