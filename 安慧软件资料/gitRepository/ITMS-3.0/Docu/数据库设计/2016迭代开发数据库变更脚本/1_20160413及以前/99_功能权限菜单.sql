...
values('00','00','首页','','root',1,1,null,null);
insert into t_sys_menu (menu_code,sys_config_id,menu_name,target_url,parent_code,sort_index,menu_enable_flag,remark,menu_image_url)
...
insert into t_sys_menu (menu_code,sys_config_id,menu_name,target_url,parent_code,sort_index,menu_enable_flag)
values('020401','020401','巡航方案','tpls/trafficMonitor/videoMonitor/cruise-plan-config.html','0204',1,1);
...
insert into t_sys_menu (menu_code,sys_config_id,menu_name,target_url,parent_code,sort_index,menu_enable_flag)
values('060301','060301','设备检定管理','test','0603',1,1);
insert into t_sys_menu (menu_code,sys_config_id,menu_name,target_url,parent_code,sort_index,menu_enable_flag)
values('060302','060302','检定证书同步','tpls/deviceManage/deviceCertification/certification-synchronize-list.html','0603',2,1);
insert into t_sys_menu (menu_code,sys_config_id,menu_name,target_url,parent_code,sort_index,menu_enable_flag)
values('060303','060303','设备未登记','tpls/deviceManage/deviceCertification/device-unregistered-list.html','0603',3,1);
...
insert into t_sys_menu (menu_code,sys_config_id,menu_name,target_url,parent_code,sort_index,menu_enable_flag)
values('070310','070310','数据延迟分析','tpls/passVehicle/dataLatencyManager/data-lantency-anylsis.html','0703',10,1);
...
insert into t_sys_menu (menu_code,sys_config_id,menu_name,target_url,parent_code,sort_index,menu_enable_flag)
values('080503','080503','路口信息','tpls/sysManagement/roadNetworkMessage/crossing-message-list.html','0805',3,0);
...
values('0001','00','通知公告','1');
insert into t_sys_function(function_code,menu_code,function_name,function_flag)
values('0002','00','下载专区','1');
...
insert into t_sys_function(function_code,menu_code,function_name,function_flag)
values('06020101','060201','设备启用','1');
insert into t_sys_function(function_code,menu_code,function_name,function_flag)
values('06020102','060201','设备删除','1');
...
insert into t_sys_function(function_code,menu_code,function_name,function_flag)
values('06030101','060301','设备检定管理','1');
insert into t_sys_function(function_code,menu_code,function_name,function_flag)
values('06030201','060302','检定证书同步','1');
insert into t_sys_function(function_code,menu_code,function_name,function_flag)
values('06030301','060303','设备未登记','1');
...
insert into t_sys_function(function_code,menu_code,function_name,function_flag)
values('07031001','070310','数据延迟分析','1');
