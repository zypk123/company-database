...
public class ProcessInstanceDiagramCmd implements Command<InputStream> {
    ...
    public ProcessInstanceDiagramCmd(String processInstanceId, RuntimeService runtimeService, RepositoryService repositoryService,ProcessEngineImpl processEngine, HistoryService historyService) {
    ...
    public InputStream execute(CommandContext commandContext) {
        ...
        GetBpmnModelCmd getBpmnModelCmd = new GetBpmnModelCmd(processDefinition.getId());
