...
public class VehtrackPassToVio {
	private String deviceId;
	private String vioSuspectedId;
	...
	private String identifyAccordance;

	private String vioCode;

	private String confirmFlag;

	private String isChangeVio;
	...
	private String vioSuspectedDesc;
	...
	public String getVioSuspectedId() {
		return vioSuspectedId;
	}

	public void setVioSuspectedId(String vioSuspectedId) {
		this.vioSuspectedId = vioSuspectedId;
	}
	...
	public String getIdentifyAccordance() {
		return identifyAccordance;
	}

	public void setIdentifyAccordance(String identifyAccordance) {
		this.identifyAccordance = identifyAccordance;
	}
	...
	public String getIsChangeVio() {
		return isChangeVio;
	}

	public void setIsChangeVio(String isChangeVio) {
		this.isChangeVio = isChangeVio;
	}
	...
	public String getVioSuspectedDesc() {
		return vioSuspectedDesc;
	}

	public void setVioSuspectedDesc(String vioSuspectedDesc) {
		this.vioSuspectedDesc = vioSuspectedDesc;
	}
	...
	public String getVioSiteName() {
		return vioSiteName;
	}

	public void setVioSiteName(String vioSiteName) {
		this.vioSiteName = vioSiteName;
	}
