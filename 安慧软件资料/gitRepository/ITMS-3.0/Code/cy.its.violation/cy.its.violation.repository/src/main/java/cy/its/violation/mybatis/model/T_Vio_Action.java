...
public class T_Vio_Action {
    ...
    private Integer fineScore;

    private Integer fineMax;

    private Integer fineMin;

    private Integer fineDefault;

    private Integer suspendMonthMax;

    private Integer suspendMonthMin;

    private Integer detainDaysMax;

    private Integer detainDaysMin;
    ...
    public Integer getFineScore() {
        return fineScore;
    }

    public void setFineScore(Integer fineScore) {
        this.fineScore = fineScore;
    }

    public Integer getFineMax() {
        return fineMax;
    }

    public void setFineMax(Integer fineMax) {
        this.fineMax = fineMax;
    }

    public Integer getFineMin() {
        return fineMin;
    }

    public void setFineMin(Integer fineMin) {
        this.fineMin = fineMin;
    }

    public Integer getFineDefault() {
        return fineDefault;
    }

    public void setFineDefault(Integer fineDefault) {
        this.fineDefault = fineDefault;
    }

    public Integer getSuspendMonthMax() {
        return suspendMonthMax;
    }

    public void setSuspendMonthMax(Integer suspendMonthMax) {
        this.suspendMonthMax = suspendMonthMax;
    }

    public Integer getSuspendMonthMin() {
        return suspendMonthMin;
    }

    public void setSuspendMonthMin(Integer suspendMonthMin) {
        this.suspendMonthMin = suspendMonthMin;
    }

    public Integer getDetainDaysMax() {
        return detainDaysMax;
    }

    public void setDetainDaysMax(Integer detainDaysMax) {
        this.detainDaysMax = detainDaysMax;
    }

    public Integer getDetainDaysMin() {
        return detainDaysMin;
    }

    public void setDetainDaysMin(Integer detainDaysMin) {
    ...
    public void setIssueEndDay(Date issueEndDay) {
