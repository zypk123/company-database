...
public class DeviceSysUseStatus {
	...
	public String getDeviceOrRegion() {
		return deviceOrRegion;
	}

	public void setDeviceOrRegion(String deviceOrRegion) {
		this.deviceOrRegion = deviceOrRegion;
	}
}