...
public abstract class _PlateImageStoreDisp extends Ice.ObjectImpl implements PlateImageStore
{
    protected void
    ...
    {
        "::Ice::Object",
        "::LDTSSInterface::PlateImageStore"
    };
    ...
    public final void
    StoreVehicle_async(AMD_PlateImageStore_StoreVehicle __cb, PassingVehicle vehicle, VehicleImage[] vehicleImages)
    {
        StoreVehicle_async(__cb, vehicle, vehicleImages, null);
    }

    public final void
    StoreVehicle2_async(AMD_PlateImageStore_StoreVehicle2 __cb, PassingVehicle vehicle, byte[] imageData)
    {
    ...
    ___StoreVehicle(PlateImageStore __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        ...
        __is.endReadEncaps();
        AMD_PlateImageStore_StoreVehicle __cb = new _AMD_PlateImageStore_StoreVehicle(__inS);
        try
        {
    ...
    public static Ice.DispatchStatus
    ___StoreVehicle2(PlateImageStore __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
        ...
        __is.endReadEncaps();
        AMD_PlateImageStore_StoreVehicle2 __cb = new _AMD_PlateImageStore_StoreVehicle2(__inS);
        try
        {
    ...
    public static Ice.DispatchStatus
    ___RetrieveVehicleInfo(PlateImageStore __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
    ...
    public static Ice.DispatchStatus
    ___RetrieveVehicleImages(PlateImageStore __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
    ...
    public static Ice.DispatchStatus
    ___QueryVehicleByTime(PlateImageStore __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
    ...
    public static Ice.DispatchStatus
    ___CountVehicleByTime(PlateImageStore __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Idempotent, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
    ...
    public static Ice.DispatchStatus
    ___UpdateVehicleInfo(PlateImageStore __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        IceInternal.BasicStream __is = __inS.is();
        __is.startReadEncaps();
    ...
    __write(Ice.OutputStream __outS)
    {
        ...
        ex.reason = "type LDTSSInterface::PlateImageStore was not generated with stream support";
        throw ex;
    }
