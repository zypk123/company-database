...
final class _AMD_PlateImageStore_StoreVehicle extends IceInternal.IncomingAsync implements AMD_PlateImageStore_StoreVehicle
{
    public
    _AMD_PlateImageStore_StoreVehicle(IceInternal.Incoming in)
    {
        super(in);
    }
