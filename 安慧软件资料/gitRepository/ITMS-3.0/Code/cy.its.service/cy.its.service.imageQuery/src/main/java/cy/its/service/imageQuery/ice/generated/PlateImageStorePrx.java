...
public interface PlateImageStorePrx extends Ice.ObjectPrx
{
    ...
    public boolean StoreVehicle_async(AMI_PlateImageStore_StoreVehicle __cb, PassingVehicle vehicle, VehicleImage[] vehicleImages);

    public boolean StoreVehicle_async(AMI_PlateImageStore_StoreVehicle __cb, PassingVehicle vehicle, VehicleImage[] vehicleImages, java.util.Map<String, String> __ctx);
    ...
    public boolean StoreVehicle2_async(AMI_PlateImageStore_StoreVehicle2 __cb, PassingVehicle vehicle, byte[] imageData);

    public boolean StoreVehicle2_async(AMI_PlateImageStore_StoreVehicle2 __cb, PassingVehicle vehicle, byte[] imageData, java.util.Map<String, String> __ctx);
    ...
    public boolean RetrieveVehicleInfo_async(AMI_PlateImageStore_RetrieveVehicleInfo __cb, String deviceNo, String snapNbr);

    public boolean RetrieveVehicleInfo_async(AMI_PlateImageStore_RetrieveVehicleInfo __cb, String deviceNo, String snapNbr, java.util.Map<String, String> __ctx);
    ...
    public boolean RetrieveVehicleImages_async(AMI_PlateImageStore_RetrieveVehicleImages __cb, String deviceNo, String snapNbr);

    public boolean RetrieveVehicleImages_async(AMI_PlateImageStore_RetrieveVehicleImages __cb, String deviceNo, String snapNbr, java.util.Map<String, String> __ctx);
    ...
    public boolean QueryVehicleByTime_async(AMI_PlateImageStore_QueryVehicleByTime __cb, String startTime, String endTime, String deviceNo, int pageSize, int pageIndex);

    public boolean QueryVehicleByTime_async(AMI_PlateImageStore_QueryVehicleByTime __cb, String startTime, String endTime, String deviceNo, int pageSize, int pageIndex, java.util.Map<String, String> __ctx);
    ...
    public boolean CountVehicleByTime_async(AMI_PlateImageStore_CountVehicleByTime __cb, String startTime, String endTime, String deviceNo);

    public boolean CountVehicleByTime_async(AMI_PlateImageStore_CountVehicleByTime __cb, String startTime, String endTime, String deviceNo, java.util.Map<String, String> __ctx);
    ...
    public boolean UpdateVehicleInfo_async(AMI_PlateImageStore_UpdateVehicleInfo __cb, PassingVehicle vehicle);

    public boolean UpdateVehicleInfo_async(AMI_PlateImageStore_UpdateVehicleInfo __cb, PassingVehicle vehicle, java.util.Map<String, String> __ctx);
}
