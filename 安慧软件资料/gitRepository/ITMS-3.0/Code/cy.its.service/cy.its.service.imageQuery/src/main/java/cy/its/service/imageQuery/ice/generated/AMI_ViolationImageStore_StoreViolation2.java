...
public abstract class AMI_ViolationImageStore_StoreViolation2 extends Callback_ViolationImageStore_StoreViolation2
{
    public abstract void ice_response(boolean __ret, ViolationVehicle savedViolation);
    ...
    public final void response(boolean __ret, ViolationVehicle savedViolation)
    {
        ice_response(__ret, savedViolation);
    }
