...
public final class PassingImageStorePrxHelper extends Ice.ObjectPrxHelperBase implements PassingImageStorePrx
{
    public int
    ...
    CountVehicleByTime(String startTime, String endTime, String deviceNo, java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        ...
        while(true)
        {
            ...
            try
            {
                ...
                _PassingImageStoreDel __del = (_PassingImageStoreDel)__delBase;
    ...
    public boolean
    CountVehicleByTime_async(AMI_PassingImageStore_CountVehicleByTime __cb, String startTime, String endTime, String deviceNo)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    CountVehicleByTime_async(AMI_PassingImageStore_CountVehicleByTime __cb, String startTime, String endTime, String deviceNo, java.util.Map<String, String> __ctx)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    QueryVehicleByTime_async(AMI_PassingImageStore_QueryVehicleByTime __cb, String startTime, String endTime, String deviceNo, int pageSize, int pageIndex)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    QueryVehicleByTime_async(AMI_PassingImageStore_QueryVehicleByTime __cb, String startTime, String endTime, String deviceNo, int pageSize, int pageIndex, java.util.Map<String, String> __ctx)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    RetrieveVehicleImages_async(AMI_PassingImageStore_RetrieveVehicleImages __cb, String deviceNo, String snapNbr)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    RetrieveVehicleImages_async(AMI_PassingImageStore_RetrieveVehicleImages __cb, String deviceNo, String snapNbr, java.util.Map<String, String> __ctx)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    RetrieveVehicleInfo_async(AMI_PassingImageStore_RetrieveVehicleInfo __cb, String deviceNo, String snapNbr)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    RetrieveVehicleInfo_async(AMI_PassingImageStore_RetrieveVehicleInfo __cb, String deviceNo, String snapNbr, java.util.Map<String, String> __ctx)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    StoreVehicle_async(AMI_PassingImageStore_StoreVehicle __cb, PassingVehicle vehicle, VehicleImage[] vehicleImages)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    StoreVehicle_async(AMI_PassingImageStore_StoreVehicle __cb, PassingVehicle vehicle, VehicleImage[] vehicleImages, java.util.Map<String, String> __ctx)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    StoreVehicle2_async(AMI_PassingImageStore_StoreVehicle2 __cb, PassingVehicle vehicle, byte[] imageData)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    StoreVehicle2_async(AMI_PassingImageStore_StoreVehicle2 __cb, PassingVehicle vehicle, byte[] imageData, java.util.Map<String, String> __ctx)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    UpdateVehicleInfo_async(AMI_PassingImageStore_UpdateVehicleInfo __cb, PassingVehicle vehicle)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public boolean
    UpdateVehicleInfo_async(AMI_PassingImageStore_UpdateVehicleInfo __cb, PassingVehicle vehicle, java.util.Map<String, String> __ctx)
    {
        Ice.AsyncResult __r;
        try
        {
    ...
    public static PassingImageStorePrx
    checkedCast(Ice.ObjectPrx __obj)
    {
        PassingImageStorePrx __d = null;
        if(__obj != null)
        {
            try
            {
                __d = (PassingImageStorePrx)__obj;
            }
            catch(ClassCastException ex)
            {
                if(__obj.ice_isA("::LDTSSInterface::PassingImageStore"))
                {
                    PassingImageStorePrxHelper __h = new PassingImageStorePrxHelper();
    ...
    checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            {
                if(__obj.ice_isA("::LDTSSInterface::PassingImageStore", __ctx))
                {
                    PassingImageStorePrxHelper __h = new PassingImageStorePrxHelper();
                    __h.__copyFrom(__obj);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::LDTSSInterface::PassingImageStore"))
                {
                    PassingImageStorePrxHelper __h = new PassingImageStorePrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ...
        if(__obj != null)
        {
            ...
            try
            {
                if(__bb.ice_isA("::LDTSSInterface::PassingImageStore", __ctx))
                {
                    PassingImageStorePrxHelper __h = new PassingImageStorePrxHelper();
                    __h.__copyFrom(__bb);
                    __d = __h;
    ...
    __createDelegateM()
    {
        return new _PassingImageStoreDelM();
    }

    protected Ice._ObjectDelD
    __createDelegateD()
    {
        return new _PassingImageStoreDelD();
    }

    public static void
    __write(IceInternal.BasicStream __os, PassingImageStorePrx v)
    {
        __os.writeProxy(v);
    }
    ...
    __read(IceInternal.BasicStream __is)
    {
        ...
        if(proxy != null)
        {
            PassingImageStorePrxHelper result = new PassingImageStorePrxHelper();
