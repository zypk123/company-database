...
public interface _PlateImageStoreOperationsNC
{
    void StoreVehicle_async(AMD_PlateImageStore_StoreVehicle __cb, PassingVehicle vehicle, VehicleImage[] vehicleImages);

    void StoreVehicle2_async(AMD_PlateImageStore_StoreVehicle2 __cb, PassingVehicle vehicle, byte[] imageData);
