...
public class DbAccess {
	 ...
	 * @throws Exception
	 */
	public int executeNonQuery(String sql, List<Object> parameters) throws Exception {
		return DbCore.executeNonQuery(this.conn, sql, parameters);
	}
	 ...
	 * @throws Exception
	 */
	public <T> List<T> executeDataset(Class<T> cls, String sql, List<Object> parameters) throws Exception {
		return DbCore.executeDataset(this.conn, cls, sql, parameters);
	}
