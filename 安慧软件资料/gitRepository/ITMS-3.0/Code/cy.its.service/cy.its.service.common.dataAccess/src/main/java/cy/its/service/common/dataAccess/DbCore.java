...
class DbCore {
	...
	public static <T> List<T> executeDataset(Connection conn, Class<T> cls, String sql, List<Object> parameters)
			throws Exception {
		PreparedStatement ps = null;
		ResultSet result = null;
		try {
	...
	public static int executeNonQuery(Connection conn, String sql, List<Object> parameters)
			throws Exception, SQLException {
		PreparedStatement ps = null;
		int result;
		try {
