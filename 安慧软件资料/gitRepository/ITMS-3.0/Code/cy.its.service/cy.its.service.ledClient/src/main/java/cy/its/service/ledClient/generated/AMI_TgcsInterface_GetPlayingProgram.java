...
public abstract class AMI_TgcsInterface_GetPlayingProgram extends Callback_TgcsInterface_GetPlayingProgram
{
    public abstract void ice_response(ProgramResponse __ret);
    ...
    public final void response(ProgramResponse __ret)
    {
        ice_response(__ret);
    }
