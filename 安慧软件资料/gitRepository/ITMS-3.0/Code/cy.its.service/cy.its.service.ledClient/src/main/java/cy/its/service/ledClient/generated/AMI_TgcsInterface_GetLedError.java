...
public abstract class AMI_TgcsInterface_GetLedError extends Callback_TgcsInterface_GetLedError
{
    public abstract void ice_response(LedErrorResponse __ret);
    ...
    public final void response(LedErrorResponse __ret)
    {
        ice_response(__ret);
    }
