...
public abstract class AMI_TgcsInterface_GetScreenStatus extends Callback_TgcsInterface_GetScreenStatus
{
    public abstract void ice_response(ScreenStatusResponse __ret);
    ...
    public final void response(ScreenStatusResponse __ret)
    {
        ice_response(__ret);
    }
