...
public abstract class AMI_TgcsInterface_GetDevice extends Callback_TgcsInterface_GetDevice
{
    public abstract void ice_response(DeviceInfo[] __ret);
    ...
    public final void response(DeviceInfo[] __ret)
    {
        ice_response(__ret);
    }
