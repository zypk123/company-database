...
public abstract class AMI_TgcsDeviceMgr_GetDevices extends Callback_TgcsDeviceMgr_GetDevices
{
    public abstract void ice_response(TgcsDevice[] __ret);
    ...
    public final void response(TgcsDevice[] __ret)
    {
        ice_response(__ret);
    }
