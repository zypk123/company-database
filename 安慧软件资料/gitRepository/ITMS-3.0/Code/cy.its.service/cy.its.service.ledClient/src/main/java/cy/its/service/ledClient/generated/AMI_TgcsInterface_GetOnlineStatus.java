...
public abstract class AMI_TgcsInterface_GetOnlineStatus extends Callback_TgcsInterface_GetOnlineStatus
{
    public abstract void ice_response(OnlineStatusResponse __ret);
    ...
    public final void response(OnlineStatusResponse __ret)
    {
        ice_response(__ret);
    }
