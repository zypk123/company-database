...
public class DeviceMonitorScoket  extends WebscoketServiceImplA implements IWebscoketReceiver{
	 ...
	 * 两个KEY可以是同一个
	 */
	private final String monitorKey="deviceMonitor";
	
	
	private DeviceMonitorScoket(){
