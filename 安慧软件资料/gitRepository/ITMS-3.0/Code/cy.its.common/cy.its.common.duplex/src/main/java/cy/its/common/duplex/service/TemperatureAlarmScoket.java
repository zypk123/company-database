/**
 * @Title: TemperatureAlarmScoket.java
 * @Package cy.its.common.duplex.service
 * @Description: TODO(这里要填写用途)
 * @author gyf guanyf@cychina.cn
 * @date 2015年12月17日 下午4:52:19
 * @version V1.0
 * @Revision : $Rev$
 * @Id: $Id$
 *
...
public class TemperatureAlarmScoket extends WebscoketServiceImplA implements IWebscoketReceiver{
	/*
	 * 日志
	 */
	private Log4jFactoryProxy log = Log4jFactoryProxy.getSingleton(TemperatureAlarmScoket.class);
	
	private final String routingKey="its_temperature_alarm";
	/**
	 * 两个KEY可以是同一个
	 */
	private final String monitorKey="temperatureAlarm";
	
	private TemperatureAlarmScoket(){
