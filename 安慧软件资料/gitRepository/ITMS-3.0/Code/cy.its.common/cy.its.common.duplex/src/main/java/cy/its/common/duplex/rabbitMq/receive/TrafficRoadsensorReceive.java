/**
 * @Title: TrafficRoadsensorReceive.java
 * @Package cy.its.common.duplex.rabbitMq.receive
 * @Description: TODO(这里要填写用途)
 * @author gyf guanyf@cychina.cn
 * @date 2015年12月9日 下午3:07:12
 * @version V1.0
 * @Revision : $Rev$
 * @Id: $Id$
 *
...
public class TrafficRoadsensorReceive  implements IMqReceiver{
	/**
	 * 临时保存注册信息
	 */
	...
	public Boolean receive(String routingKey,String message) {
		...
		//最新状态数据放入redis
		RedisPoolUtil.hset("tf:roadsensor",jsonObject.getString("deviceSysNbr"), message);
		//缓存更新完成
		return status;
	}
