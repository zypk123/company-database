...
/**
* @Title: TrafficAutoMonitorScoket.java 
* @Package com.cy.task.service 
* @Description:自动监测 事件服务
* @author lil@cychina.cn
* @date 2015年10月30日 上午10:59:15 
* @version V1.0   
 */
public class TrafficAutoMonitorScoket  extends WebscoketServiceImplA implements IWebscoketReceiver{
	/*
	 * 日志
	 */
	private Log4jFactoryProxy log = Log4jFactoryProxy.getSingleton(TrafficStatusScoket.class);
	
	private final String routingKey="traffic_auto";
	/**
	 * 两个KEY可以是同一个
	 */
	private final String monitorKey="trafficAutoMonitor";
	
	private TrafficAutoMonitorScoket(){
