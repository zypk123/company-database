/**
 * @Title: WaterThicknessAlarmScoket.java
 * @Package cy.its.common.duplex.rabbitMq.receive
 * @Description: TODO(这里要填写用途)
 * @author gyf guanyf@cychina.cn
 * @date 2015年12月17日 下午4:55:09
 * @version V1.0
 * @Revision : $Rev$
 * @Id: $Id$
 *
...
import cy.its.common.duplex.service.TrafficStatusScoket;
import cy.its.common.duplex.service.impl.WebscoketServiceImplA;
import cy.its.platform.common.utils.Log4jFactoryProxy;

public class WaterThicknessAlarmScoket extends WebscoketServiceImplA implements IWebscoketReceiver{
	/*
	 * 日志
	 */
	private Log4jFactoryProxy log = Log4jFactoryProxy.getSingleton(WaterThicknessAlarmScoket.class);
	
	private final String routingKey="its_waterThickness_alarm";
	/**
	 * 两个KEY可以是同一个
	 */
	private final String monitorKey="waterThicknessAlarm";
	
	private WaterThicknessAlarmScoket(){
