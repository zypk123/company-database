/**
 * @Title: VisibilityAlarmScoket.java
 * @Package cy.its.common.duplex.service
 * @Description: TODO(这里要填写用途)
 * @author gyf guanyf@cychina.cn
 * @date 2015年12月16日 下午2:02:48
 * @version V1.0
 * @Revision : $Rev$
 * @Id: $Id$
 *
...
public class VisibilityAlarmScoket  extends WebscoketServiceImplA implements IWebscoketReceiver{
	/*
	 * 日志
	 */
	private Log4jFactoryProxy log = Log4jFactoryProxy.getSingleton(VisibilityAlarmScoket.class);
	
	private final String routingKey="its_visibility_alarm";
	/**
	 * 两个KEY可以是同一个
	 */
	private final String monitorKey="visibilityAlarm";
	
	private VisibilityAlarmScoket(){
