/**
 * @Title: TrafficEventScoket.java
 * @Package cy.its.common.duplex.service
 * @Description: TODO(这里要填写用途)
 * @author gyf guanyf@cychina.cn
 * @date 2015年12月14日 下午4:41:17
 * @version V1.0
 * @Revision : $Rev$
 * @Id: $Id$
 *
...
public class TrafficEventScoket extends WebscoketServiceImplA implements IWebscoketReceiver{
	/*
	 * 日志
	 */
	private Log4jFactoryProxy log = Log4jFactoryProxy.getSingleton(TrafficEventScoket.class);
	
	private final String routingKey="its_traffic_event_alarm";
	/**
	 * 两个KEY可以是同一个
	 */
	private final String monitorKey="trafficEvent";
	
	private TrafficEventScoket(){
