/**
 * @Title: SectionAlarmScoket.java
 * @Package cy.its.common.duplex.service
 * @Description: TODO(这里要填写用途)
 * @author gyf guanyf@cychina.cn
 * @date 2015年12月22日 下午3:22:48
 * @version V1.0
 * @Revision : $Rev$
 * @Id: $Id$
 *
...
public class SectionAlarmScoket extends WebscoketServiceImplA implements IWebscoketReceiver{
	/*
	 * 日志
	 */
	private Log4jFactoryProxy log = Log4jFactoryProxy.getSingleton(SectionAlarmScoket.class);
	
	private final String routingKey="its_section_alarm";
	/**
	 * 两个KEY可以是同一个
	 */
	private final String monitorKey="sectionAlarm";
	
	private SectionAlarmScoket(){
