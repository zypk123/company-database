/**
 * @Title: TrafficVisibilityScoket.java
 * @Package cy.its.common.duplex.service
 * @Description: TODO(这里要填写用途)
 * @author gyf guanyf@cychina.cn
 * @date 2015年12月8日 下午7:54:18
 * @version V1.0
 * @Revision : $Rev$
 * @Id: $Id$
 *
...
public class TrafficVisibilityScoket extends WebscoketServiceImplA implements IWebscoketReceiver{
	/*
	 * 日志
	 */
	private Log4jFactoryProxy log = Log4jFactoryProxy.getSingleton(TrafficVisibilityScoket.class);
	
	private final String routingKey="its_visibility";
	/**
	 * 两个KEY可以是同一个
	 */
	private final String monitorKey="trafficVisibility";
	
	private TrafficVisibilityScoket(){
