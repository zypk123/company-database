...
public class ExcelUtil<T> {
	 ...
	 * @param ignoreRows 忽略前几行（忽略第一行传1）
	 * @return
	 * @throws IOException
	 * @return List<String[]> 
	 ...
	 *
	 * @Title: exportExcel
	 * @param collection   	Collection<T> 要生成excel的数据
	 * @param keys       	String[] collection中泛型类中的属性名
	 * @param header     	表格列名
	...
	/**
	 * 将对象列表数据生成excel(2007) 放入数据流中 
	 * 日期类型输出格式默认为yyyy-MM-dd
	 *
	 * @Title: exportExcel
	 * @param collection   	Collection<T> 要生成excel的数据
	 * @param keys       	String[] collection中泛型的属性名
	 * @param header     	表格列名
	 * @param outputStream	输出流
	 * @return void
	 * @throws IOException 
	 ...
	 *
	 * @Title: exportExcel
	 * @param dataList   	List<Map<String, String>> 要生成excel的数据
	 * @param keys       	String[] dataList中每个map的key
	 * @param header     	表格列名
	 * @param outputStream	输出流
	 * @return void
	 * @throws IOException 
