...
public class RedisPoolUtil {
	   ...
	   private static Log4jFactoryProxy log = Log4jFactoryProxy.getSingleton(RedisPoolUtil.class);
	...
	*/
	...
	/** 
		...
		* @throws 
		*/
		public static List<String> getKeyList(String keys) {
	        ...
	        try {  
	            ...
	            jedis = pool.getResource();  
	            jedis.select(index);
	            Set<String> setKeys = jedis.keys(keys+"*");
