...
<script type="text/javascript">
	...
	function openTab(text,url,iconCls){
		if($("#tabs").tabs("exists",text)){ //如果是存在的就选中
		...
		$("#fm").form("submit",{
			...
			onSubmit:function(){
				...
				if(newPassword!=newPassword2){
					$.messager.alert("系统提示","两次输入的新密码不一致！");
					return false;
				}
				return true;
			},
...
<div region="south" style="height: 25px;padding: 5px" align="center">
	版本所有 @一直、很安静 <a href="http://user.qzone.qq.com/729235023" target="_blank">http://user.qzone.qq.com/729235023</a>
</div>
