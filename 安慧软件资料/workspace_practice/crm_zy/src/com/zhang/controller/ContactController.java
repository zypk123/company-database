...
public class ContactController {
	 ...
	 */
	@RequestMapping("/list")
	public String list(@RequestParam(value = "cusId", required = false) String cusId, HttpServletResponse response)
			throws Exception {
	...
	public String delete(@RequestParam(value = "id") String id, HttpServletResponse response) throws Exception {
		int resultTotal = contactService.delete(Integer.parseInt(id));
		JSONObject result = new JSONObject();
		if(0!=resultTotal){
			result.put("success", true);
		}else{
