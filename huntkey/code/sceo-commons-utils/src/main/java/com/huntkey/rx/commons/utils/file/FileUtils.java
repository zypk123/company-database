package com.huntkey.rx.commons.utils.file;
...
public class FileUtils {
	...
	public static boolean rename(String filePath, String definedName) {
		...
		if (file.exists()) {
			...
			if (file.renameTo(new File(rename))) {
				...
				logger.debug("修改文件名失败，该文件已存在：{} TO {}", file.getAbsoluteFile(), rename);
				return false;
			}
		} else {
	...
	public static void main(String[] args) {
		String path1 = "E:\\work\\idea\\huntkey-rx\\biz-formula-designer\\formula-provider\\target\\classes\\jar\\hdfs\\18dfb892bf0f40dbac1dbfcb136dacd1\\";
		System.out.println(FileUtils.deleteDirectory(path1));
