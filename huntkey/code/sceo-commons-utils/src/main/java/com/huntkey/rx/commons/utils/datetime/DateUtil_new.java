...
/**
 * @ClassName: DateUtil_new
 * @Description: JDK1.8全新时间API使用
 * @author: zhangyu
 * @date: 2017年4月11日下午7:11:18
 */
public class DateUtil_new {
    ...
    public enum TimeFormat {
         ...
         * 短时间格式
         */
        SHORT_DATE_PATTERN_LINE("yyyy-MM-dd"), SHORT_DATE_PATTERN_SLASH("yyyy/MM/dd"), SHORT_DATE_PATTERN_DOUBLE_SLASH("yyyy\\MM\\dd"), SHORT_DATE_PATTERN_NONE("yyyyMMdd"),
