...
public class StringUtils {
     ...
     * @return
     */
    public static <T extends BaseEntity> T preUpdateEntity(T t) {
        t.setModtime(new Date());
        t.setModuser(UserUtil.getUserId());
        return t;
    }
     ...
     * @return
     */
    public static <T extends BaseEntity> T preInstallEntity(T t) {
        t.setCretime(new Date());
        t.setCreuser(UserUtil.getUserId());
        return t;
    }
}
