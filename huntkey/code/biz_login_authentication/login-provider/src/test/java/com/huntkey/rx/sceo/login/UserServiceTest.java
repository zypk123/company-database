...
public class UserServiceTest {
    ...
    public void updateStuTest() throws Exception {
        ...
        EpeoEpeoStuSetaEntity load = ormService.load(EpeoEpeoStuSetaEntity.class, "2c270808e5cf480e9574662110b904a3");
        load.setEpeo_stu_end(null);
        Result result = userService.modStuSet(load);
        logger.info("-----------");
        logger.info(JSONObject.toJSONString(result));
        Assert.assertEquals(Result.RECODE_SUCCESS, result.getRetCode());
        logger.info("-----------");
