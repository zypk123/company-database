...
public class UserController {
    ...
    public Result updatePeopleInfo(@RequestBody PeopleEntity peopleEntity) {
        ...
        try {
            ...
            throw new RuntimeException("updatePeopleInfo error : " + e.getMessage(), e);
        }
        return result;
    }
    ...
    public Result certification(@RequestBody UserInfo userInfo) {
        Result result = null;
        try {
            result = userService.certification(userInfo);
        } catch (Exception e) {
            logger.error("certification error : " + e.getMessage(), e);
            throw new RuntimeException("certification error : " + e.getMessage(), e);
        }
        return result;
    }
