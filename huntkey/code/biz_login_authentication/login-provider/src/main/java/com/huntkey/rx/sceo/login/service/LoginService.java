...
import com.huntkey.rx.sceo.common.entity.RetrievePassVo;
...
public interface LoginService {
     ...
     * @return
     */
    Result checkCardNoAndTel(String epeoCardNo, String epeoTel);
     ...
     * @return
     */
    Result retrievePass(RetrievePassVo retrievePassVo);
