 ...
 * <p>
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * CEILING(number: number, significance: int): decimal
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * <p>
 * @author chenfei on 2017/5/15.
 */
public class CEILING extends MathFunction {

    @Override
    protected void buildParamsDesc(FunctionDescriber describer) {

        StringBuffer buff = new StringBuffer();
        buff.append("返回将参数 number 向上舍入（沿绝对值增大的方向）为最接近的指定基数的倍数\n")
                .append("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
                .append("CEILING(number: number, significance: int): decimal\n")
                .append("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
    ...
    private Object getResult(BigDecimal divisor, int significance) {
        ...
        if (divisor.compareTo(BigDecimal.ZERO) > 0 && significance > 0) {
            result = Arith.mul(divisor.toBigInteger().doubleValue() + 1, significance);
