 ...
 * <p>
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * LARGE(array: number[], k: int): decimal
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * <p>
 * @author chenfei on 2017/5/15.
 */
public class LARGE extends MathFunction {

    @Override
    protected void buildParamsDesc(FunctionDescriber describer) {

        StringBuffer buff = new StringBuffer();
        buff.append("返回数据集中第k个最大值\n")
                .append("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
                .append("LARGE(Number: number, k: int): decimal\n")
                .append("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
    ...
    public ExprValue getValue(DataProvider provider) throws FormulaException {
        ...
        try {
            ...
            // can only supports primitive type.
            if (ExprValue.DataType.ARR.equals(number.getDataType())) {
                ...
                throw new FormulaException("LARGE function supports arr type array as the first argument.");
            }
        } catch (Exception e) {
            throw new FormulaException("LARGE function supports double type array as the first argument.", e);
        }
    }
