 ...
 *
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * RIGHT(text: varchar, numChars: int): varchar
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 *
...
public class RIGHT extends TextFunction {
    ...
    protected void buildParamsDesc(FunctionDescriber describer) {
        ...
        buff.append("从一个文本字符串的右边第一个字符开始返回指定个数的字符\n")
            .append("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n")
            .append("RIGHT(text: varchar, numChars: int): varchar\n")
            .append("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~\n");
    ...
    public ExprValue getValue(DataProvider provider) throws FormulaException {
        ...
        return new ExprValue(text.substring(text.length() - numChars, text.length()));
    }
}
