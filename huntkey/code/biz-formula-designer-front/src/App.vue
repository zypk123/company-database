<template>
  <div id="app" ><!-- class="debug" -->
    <el-menu  v-if="showMenu" :router="true"
      default-active="1" class="app_menu primary-bg" mode="horizontal" id="tabs">
      <el-submenu index="1">
        <template slot="title">
          <span class="main-menu-item">系统功能</span>
        </template>
          <!-- <router-link to='/var-manage' class="menu-item">
            <el-menu-item index="1-1">
              变量管理
            </el-menu-item>
          </router-link> -->
          <el-menu-item index="func-manage">
            函数管理
          </el-menu-item>
          <el-menu-item index="var-manage">
            变量管理
          </el-menu-item>
          <el-menu-item index="func-desc-language">
            方法描述语言
          </el-menu-item>
      </el-submenu>

      <el-menu-item index="mock-entry" class="main-menu-item">
        模拟入口
      </el-menu-item>
    </el-menu>
